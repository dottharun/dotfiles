...
-- vim.keymap.set("n", "<C-k>", function() harpoon:list():select(3) end, { desc = "goto harpoon - 3" })
-- vim.keymap.set("n", "<C-l>", function() harpoon:list():select(4) end, { desc = "goto harpoon - 4" })
